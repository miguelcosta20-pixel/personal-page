...
const navLinks = [
  ...
  },
  {
    ...
    label: "Contact",
    icon: (
      <svg viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.2" width="13" height="13" aria-hidden="true">
    ...
    <>
        ...
        <div className="max-w-5xl mx-auto px-6 h-16 flex items-center gap-4">
          ...
          <div className="flex-1 flex justify-end">
            <button
              ...
              className="sm:hidden w-11 h-11 flex flex-col items-center justify-center gap-[5px]"
              aria-label="Open menu"
            >
              <span className="block w-4 h-px bg-[#0a0a0a] rounded-full" aria-hidden="true" />
              <span className="block w-4 h-px bg-[#0a0a0a] rounded-full" aria-hidden="true" />
            </button>
          </div>
      ...
      {open && (
        ...
        >
          <button
            onClick={closeMenu}
            className="absolute top-5 right-6 w-11 h-11 flex items-center justify-center rounded-full border border-[#e5e5e5] text-[#737373] hover:text-[#0a0a0a]"
            style={{ transition: "color 160ms ease-out" }}
